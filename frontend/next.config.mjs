...
const envConfig = {
  NEXT_PUBLIC_PROCESS_INGESTION_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/process_ingestion_task',
  NEXT_PUBLIC_ON_FILE_UPLOAD_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/on_file_upload',
  NEXT_PUBLIC_TRIGGER_DILIGENCE_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/trigger_diligence',
  NEXT_PUBLIC_PROCESS_DILIGENCE_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/process_diligence_task',
  NEXT_PUBLIC_SCHEDULE_INTERVIEW_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/schedule_ai_interview',
  NEXT_PUBLIC_RUN_DILIGENCE_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/run_diligence',
  NEXT_PUBLIC_QUERY_DILIGENCE_URL: 'https://veritas-functions-533015987350.asia-south1.run.app/query_diligence',
