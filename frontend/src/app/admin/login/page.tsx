    ...
    <div className="flex min-h-screen items-center justify-center bg-background">
      ...
      <Card className="mx-auto w-full max-w-sm mt-24 shadow-xl border-border/50 bg-card/95 backdrop-blur-sm">
        <CardHeader className="text-center space-y-2 pb-6">
          ...
          <CardDescription className="text-base">Sign in to access the Admin dashboard and manage platform operations.</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 text-center text-sm space-y-2">
            {canCreateAdmin && (
              <div>
                <Link href="/admin/signup" className="underline hover:text-primary transition-colors" prefetch={false}>
